# Blazor Js Fast Data Exchanger Demo
...
## Please visit another referenced [repo](https://github.com/Lupusa87/BlazorJsFastDataExchanger/blob/master/README.md) for documentation
